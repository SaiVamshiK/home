                ...
                <div className="col-md-6">
                    <div className="card shadow-lg p-3 mb-5 bg-white rounded card" style={{cursor: 'pointer'}}>
                        <div className="card-body">
                            ...
                            <a href="https://github.com/SaiVamshiK/My-Store">Link to Repo</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="card shadow-lg p-3 mb-5 bg-white rounded card" style={{cursor: 'pointer'}}>
                        <div className="card-body">
                            ...
                            <a href="https://github.com/SaiVamshiK/pooling-app">Link to Repo</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="col-md-6">
                    <div className="card shadow-lg p-3 mb-5 bg-white rounded card" style={{cursor: 'pointer'}}>
                        <div className="card-body">
                            ...
                            <a href="https://github.com/SaiVamshiK/Real-Time-Face-Mask-Detector">Link to Repo</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="card shadow-lg p-3 mb-5 bg-white rounded card" style={{cursor: 'pointer'}}>
                        <div className="card-body">
                            ...
                            <a href="https://github.com/SaiVamshiK/Covid19-Future-Predictions-in-India">Link to Repo</a>
                        </div>
                    </div>
                </div>
            </div>
                 ...
                 <div className="col-md-6">
                    <div className="card shadow-lg p-3 mb-5 bg-white rounded card" style={{cursor: 'pointer'}}>
                        <div className="card-body">
                            ...
                            <a href="https://github.com/SaiVamshiK/Traffic-Predictor-Deloitte-Project">Link to Repo</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="card shadow-lg p-3 mb-5 bg-white rounded card" style={{cursor: 'pointer'}}>
                        <div className="card-body">
                            ...
                            <a href="https://github.com/SaiVamshiK/Data-Structure-in-C-/tree/main">Link to Repo</a>
                        </div>
                    </div>
                </div>
